...
// max kinetic segment tree with lazy propagation
// heaten: updates b_i += T * a_i in range i \in [s, e], T >= 0
// add: updates b_i += T in range i \in [s, e] 
// also supports point update queries, range max queries
